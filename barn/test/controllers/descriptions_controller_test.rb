...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { breed: @description.breed, color: @description.color, height: @description.height, markings: @description.markings, name: @description.name }
    end
  ...
  test "should update description" do
    patch :update, id: @description, description: { breed: @description.breed, color: @description.color, height: @description.height, markings: @description.markings, name: @description.name }
    assert_redirected_to description_path(assigns(:description))
  end
