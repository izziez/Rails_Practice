...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { cake: @donut.cake, cost: @donut.cost, frosting: @donut.frosting, image: @donut.image, name: @donut.name, toppings: @donut.toppings, type: @donut.type }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { cake: @donut.cake, cost: @donut.cost, frosting: @donut.frosting, image: @donut.image, name: @donut.name, toppings: @donut.toppings, type: @donut.type }
    assert_redirected_to donut_path(assigns(:donut))
  end
